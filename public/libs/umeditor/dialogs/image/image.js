...
//                }
  ...
  var Upload = {
    ...
    submit: function (callback) {
      ...
      //-- start changed by Jaxu on 11/18/2016
      var me = this;
        ...
        $.each(fileList, function (i, f) {
          if (/^image/.test(f.type)) {
            ...
            reader.onload = function () {
              ...
              xhr.open('post', me.editor.getOpt('imageUrl'));
              xhr.setRequestHeader('Authorization', 'Bearer ' + me.editor.options.token);
        ...
        me.dialog.find('.edui-image-content').on('drop', function (e) {
          ...
          $.each(fileList, function (i, f) {
            if (/^image/.test(f.type)) {
              ...
              // updated by Jaxu on 11/18/2016
              if (me.editor.options.token){
                xhr.setRequestHeader('Authorization', 'Bearer ' + me.editor.options.token);
              }
